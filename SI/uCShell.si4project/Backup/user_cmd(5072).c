...
CPU_BOOLEAN  add_user_cmd (void)
{
    ...
    Shell_CmdTblAdd((CPU_CHAR *)"Sh_user", User_CmdTbl, &err);
...
#define LED_ON      (CPU_CHAR *) "-ON"
#define LED_OFF     (CPU_CHAR *) "-OFF"

#define LED_OUT_ON          (CPU_CHAR *) "LED out leve is : ON\r\n"
#define LED_OUT_OFF          (CPU_CHAR *) "LED out leve is : OFF\r\n" 
